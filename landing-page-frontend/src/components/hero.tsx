  ...
  return (
    <section className="py-12">
      <div className="mx-auto max-w-7xl min-w-[360px] px-4 md:px-6">
        {/* Bordered wrapper */}
        <div className="rounded-3xl border border-border/60 bg-background/40 p-4 shadow-sm md:p-6">
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
            {/* Left Column - Image of Cover */}
            <div className="w-full">
              <div className="overflow-hidden rounded-xl bg-gradient-to-br from-primary/20 to-primary/5">
